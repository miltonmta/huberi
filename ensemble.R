                     ...
                     newvar_current)
{
  ...
  # bioclim_rcp26 <- stack(list.files(Pout, pattern = "bioclim_rcp26.tif$", full.names = TRUE))
  # maxent_rcp26  <- stack(list.files(Pout, pattern = "maxent_rcp26.tif$",  full.names = TRUE))
  # SVM_rcp26     <- stack(list.files(Pout, pattern = "SVM_rcp26.tif$",     full.names = TRUE))
  # 
  # bioclim_rcp45 <- stack(list.files(Pout, pattern = "bioclim_rcp45.tif$", full.names = TRUE))
  # maxent_rcp45  <- stack(list.files(Pout, pattern = "maxent_rcp45.tif$",  full.names = TRUE))
  # SVM_rcp45     <- stack(list.files(Pout, pattern = "SVM_rcp45.tif$",     full.names = TRUE))
  # 
  # bioclim_rcp60 <- stack(list.files(Pout, pattern = "bioclim_rcp60.tif$", full.names = TRUE))
  # maxent_rcp60  <- stack(list.files(Pout, pattern = "maxent_rcp60.tif$",  full.names = TRUE))
  # SVM_rcp60     <- stack(list.files(Pout, pattern = "SVM_rcp60.tif$",     full.names = TRUE))
  # 
  # bioclim_rcp85 <- stack(list.files(Pout, pattern = "bioclim_rcp85.tif$", full.names = TRUE))
  # maxent_rcp85  <- stack(list.files(Pout, pattern = "maxent_rcp85.tif$",  full.names = TRUE))
  # SVM_rcp85     <- stack(list.files(Pout, pattern = "SVM_rcp85.tif$",    full.names = TRUE))
  ...
  # rm(bioclim_c, bioclim_Pout_rcp26, bioclim_Pout_rcp45, bioclim_Pout_rcp60, bioclim_Pout_rcp85)
  ...
  # rm(gower_c, gower_Pout_rcp26, gower_Pout_rcp45, gower_Pout_rcp60, gower_Pout_rcp85)
  ...
  # rm(maxent_c, maxent_Pout_rcp26, maxent_Pout_rcp45, maxent_Pout_rcp60, maxent_Pout_rcp85)
  # 
  ...
  # rm(SVM_c, SVM_Pout_rcp26, SVM_Pout_rcp45, SVM_Pout_rcp60, SVM_Pout_rcp85)

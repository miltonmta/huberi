# huberi
This is a program for modeling the potential distribution of L. huberi and its associated host plats. We intend to study the changes in the species distribution pattern as well the species interactions in future General Circulation Models from IPCC at the all Representative Concentration Pathways (RCPs) 
